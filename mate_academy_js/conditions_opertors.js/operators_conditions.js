// Умовні оператори
// Команди в програмі виконуються послідовно, згори вниз.Але іноді ми хочемо, щоб деякі команди виконувались тільки за певних умов.Для цього використовується конструкція if.
...
// Після ключового слова if ми ставимо круглі дужки, в які записуємо умову.Далі пишуться фігурні дужки з однією або кількома командами, які спрацюють, лише якщо умова вірна.
...
//         }
//     }
// Але таку вкладену конструкцію складніше розуміти, оскільки потрібно уважно слідкувати, де дужки відкрились і де закрились.Тому зручніше використовувати оператори && і || для об'єднання умов.
...
// }
// else
// Іноді потрібно запустити різні команди коли умова виконується і коли умова НЕ виконується.Це можна зробити за допомогою 2 - х конструкцій if з протилежними умовами.
...
// Для вибору одного з двох значень є умовний оператор, який записується так умова ? значення1 : значення2.Якщо умова вірна, то обереться значення1, інакше значення2.
