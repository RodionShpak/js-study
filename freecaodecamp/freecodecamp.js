...
// // ==========================================Task-29 Поняття про команду if...Else
// Коли умова команди if правильна, то наступний блок з кодом виконується.
// Що ж коли ця умова хибна ? Зазвичай нічого не станеться.
// У випадку else, альтернативний блок коду може спрацювати.
...
// Waiting:Вам слід використати команду else
// Waiting: testElse(4) повинен видати рядок 5 or Smaller
// Waiting: testElse(5) повинен видати рядок 5 or Smaller
// Waiting: testElse(6) повинен видати рядок Bigger than 5
// Waiting: testElse(10) повинен видати рядок Bigger than 5
// Waiting:Не варто змінювати код вище або нижче зазначених коментарів.
...
// // ==========================================Task-30 Поняття про команду Else If
...
// Waiting:Щонайменше потрібно мати дві команди if
// Waiting:Кожен блок коду if else повинен мати закриті і відкриті фігурні дужки.
// Waiting: testElseIf(0) має повернути рядок Smaller than 5
// Waiting: testElseIf(5) має повернути рядок Between 5 and 10
// Waiting: testElseIf(7) має повернути рядок Between 5 and 10
// Waiting: testElseIf(10) має повернути рядок Between 5 and 10
// Waiting: testElseIf(12) має повернути рядок Greater than 10
...
// // ==========================================Task-31 Логічна послідовність в команді If Else
...
// Waiting: orderMyLogic(6) має видати рядок Less than 10
// Waiting: orderMyLogic(11) має видати рядок Greater than or equal to 10
...
// // ==========================================Task-32 Створення ланцюгу If Else(Що - Якщо)
// if/else може бути об'єднаним у разі складних алгоритмів.
// Ось pseudocode декількох ланцюжків if / else if тверджень:
...
// Waiting:Потрібно мати щонайменше 4 команди if
// Waiting:Потрібно мати щонайменше 1 команду return
// Waiting: testSize(0) має повертати рядок Tiny
// Waiting: testSize(4) має повертати рядок Tiny
// Waiting: testSize(5) має повертати рядок Small
// Waiting: testSize(8) має повертати рядок Small
// Waiting: testSize(10) має повертати рядок Medium
// Waiting: testSize(14) має повертати рядок Medium
// Waiting: testSize(15) має повертати рядок Large
// Waiting: testSize(17) має повертати рядок Large
// Waiting: testSize(20) має повертати рядок Huge
// Waiting: testSize(25) має повертати рядок Huge
...
// // ==========================================Task-33 Golf Code
// У грі гольф, кожен отвір має par, значення від середньої кількості очікуваних ударів,
//     які повинен зробити гравець, щоб потрапити м'ячем у лунку, для завершення гри.
// Залежно від того, на скільки вище або нижче par є ваші удари, існують різні псевдоніми.

// // // --------------------===================== Conditions =====================--------------------
// Ваша функція проходитиме аргументи par та strokes.
// Поверніть правильний рядок відповідно до цієї таблиці,
//     яка перелічує удари в порядку пріоритету; зверху(найвищий) до низу(найнижчий):

// Удари	Відображений результат
...
// par + 2	"Двічі Страшко"
//     >= par + 3	"Йди додому!"
// par та удари завжди будуть числовими та додатніми.
// Ми додали масив усіх ваших імен для зручності.

// // // --------------------===================== Tests =====================--------------------
// Рахунок(4, 1) має виводити стрічку В лунку з першого удару!
// Waiting: Рахунок(4, 2) має виводити стрічку Орел
// Waiting: Рахунок(5, 2) має виводити стрічку Орел
// Waiting: Рахунок(4, 3) має виводити стрічку Пташка
// Waiting: Рахунок(4, 4) має виводити стрічку Середнячок
// Waiting: Рахунок(1, 1) має виводити стрічку В лунку з першого удару!
// Waiting: Рахунок(5, 5) має виводити стрічку Середнячок
// Waiting: Рахунок(4, 5) має виводити стрічку Страшко
// Waiting: Рахунок(4, 6) має виводити стрічку Двічі Страшко
// Waiting: Рахунок(4, 7) має виводити стрічку Йди додому!
// Waiting: Рахунок(5, 9) має виводити стрічку Йди додому!
...
// // ==========================================Task-34 // Вибір з багатьох опцій за допомогою перемикачів

// Якщо у вас є багато опцій для вибору, використовуйте команду switch.
// switch тести на значення і може мати багато випадків інструкцій, які визначають різні значення.
// Інструкції виконуються від першого узгодженого значення `case до тих пір, поки break не відбудиться.

// Ось наводиться приклад інструкції switch`:

// switch (lowercaseLetter) { case "a": console.log("A"); break; case "b": console.log("B"); break; }
// case значень перевіряється абсолютною рівністю(===).
// break пропонує JavaScript припинити виконання інструкцій.
// Якщо break пропущений, тоді наступна команда буде виконуватись.
...
// Waiting: caseInSwitch(2) повинно відповідати значенню рядка beta
// Waiting: caseInSwitch(3) повинно відповідати значенню рядка gamma
// Waiting: caseInSwitch(4) повинно відповідати значенню рядка delta
// Waiting:Не варто використовувати if або else команди
// Waiting:Ви повинні мати принаймні 3 інструкції break
